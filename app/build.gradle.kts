...
android {
    ...
    lint {
        ...
        // values/strings.xml — русский (основной язык приложения, значения по умолчанию для
        // любой не перечисленной локали); values-en — полный английский перевод; values-ru
        // патчит лишь несколько случайно оставленных английских строк в базовом наборе (например
        // app_name — бренд, намеренно на английском везде). Из-за этой смешанной схемы проверка на
        // полное совпадение ключей между values/ и values-ru/ здесь неприменима.
