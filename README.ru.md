...
| Телефон | Источники будильников | Часы | Будильник на часах |
|---------|----------------------|------|-------------------|
| ![Главный экран телефона](docs/screenshots/phone-main.png) | ![Выбор источников](docs/screenshots/phone-sources.png) | ![Главный экран часов](docs/screenshots/wear-main.png) | ![Срабатывание будильника](docs/screenshots/wear-alarm.png) |
