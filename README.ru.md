...
**Текущая версия:** 2.2.3 (versionCode 32)
...
| Телефон | Часы | Будильник на часах |
|---------|------|-------------------|
| ![Главный экран телефона](docs/screenshots/phone-main.png) | ![Главный экран часов](docs/screenshots/wear-main.png) | ![Срабатывание будильника](docs/screenshots/wear-alarm.png) |
